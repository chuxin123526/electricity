...
[ {
	...
	nodes : [ {
		...
		target : 'mainFrame',
		url : '../system/userAction_list.action',
		isParent : false
	}, {
		mid : 'ao',
		pid : 'am',
		...
		target : 'mainFrame',
		url : '../system/roleAction_index.action',
		isParent : false
	}, {
		mid : 'ap',
		pid : 'am',
		...
		target : 'mainFrame',
		url : '../system/baseMessageAction_info.action',
		isParent : false
	}, {
		mid : 'aq',
		pid : 'am',
		...
		target : 'mainFrame',
		url : '../system/dataDictionaryAction_list.action',
		isParent : false
	} ]
}, {
	mid : 'ar',
