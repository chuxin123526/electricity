...
<body onload="ini()">
<form action="${pageContext.request.contextPath}/system/userAction_login.action" method="post" target="_top">
						...
						<td height="99" width="27%">
							<table border="0" width="70%" id="table4">
								<tr>
									...
									<td><input type="text" name="user.loginName" style="width: 125 px" size="20" value=""  maxlength="25"></td>
	
								</tr>
								<tr>
									<td width="100"><img border="0" src="${pageContext.request.contextPath}/images/mima.jpg" width="75" height="20"></td>
									<td><input type="password" name="user.password" style="width: 125 px" size="20" value=""  maxlength="25"></td>
