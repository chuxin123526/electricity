 ...
 <body>
    ...
    <table cellSpacing="1" cellPadding="5" width="680" align="center" bgColor="#eeeeee" style="border:1px solid #8ba7e3" border="0">
     ...
     <tr>
		 ...
		 <td class="ta_01" bgColor="#ffffff">
		 	<input name="user.name" type="text"  value="${user.name}" maxlength="25" id="userName"  size=20>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<select name="user.sex" id="sexID" style="width:155px">
			<option value=""></option>
	...
	<TR>
		...
		<TD class="ta_01" bgColor="#ffffff" colSpan="3">
			...
			<s:iterator value = "user.attachmentss">
			<a href="#" onclick="openWindow('${pageContext.request.contextPath }/system/userAction_download.action?fileID=${id}','700','400');">
			${name}
			</a>
			</s:iterator>
		</TD>
