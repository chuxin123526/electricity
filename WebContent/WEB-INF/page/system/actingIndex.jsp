...
<script language="javascript" src="${pageContext.request.contextPath }/ckeditor/ckeditor.js"></script>
  ...
  function checkchar(){
  		...
  		document.Form2.action="baseMessageAction_save.action";
							...
							<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
								<td style="HEIGHT:22px" align="center" width="40%">
									<div class="scrollStyle" align="left" onmouseover="showInfoWithPanel(this)" onmouseout="hiddenInfoPanel(this)" style="table-layout:fixed;">
										${baseMessage.stationRunCondition}
									</div>
								</td>
								<td style="HEIGHT:22px" align="center" width="40%">
									<div class="scrollStyle" align="left" onmouseover="showInfoWithPanel(this)" onmouseout="hiddenInfoPanel(this)" style="table-layout:fixed;">
										${baseMessage.equipmentRunCondition}	
									</div>
								</td>
								<td style="HEIGHT:22px" align="center" width="20%">
									<s:date name="#baseMessage.createDate" format="yyyy-MM-dd HH-mm-ss"/>
								</td>
							</tr>
	...
	<table cellspacing="1" cellpadding="5" width="90%" align="center" bgcolor="#f5fafe" style="border:1px solid #8ba7e3" border="0">
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff" style="word-break: break-all">
				...
				<textarea name="baseMessage.stationRunCondition" id="stationRun"   style="width: 500px; height: 160px; padding: 1;FONT-FAMILY: 宋体; FONT-SIZE: 9pt" onkeydown="if(event.keyCode==13)addEnter('stationRun');">${baseMessage.stationRunCondition }</textarea>
			</td>
		...
		<tr>
			...
			<td class="ta_01" bgcolor="#ffffff" style="word-break: break-all">
				<textarea name="baseMessage.equipmentRunCondition" id="devRun"  style="width: 500px; height: 160px; padding: 1;FONT-FAMILY: 宋体; FONT-SIZE: 9pt" onkeydown="if(event.keyCode==13)addEnter('devRun');">${baseMessage.equipmentRunCondition}</textarea>
			</td>
