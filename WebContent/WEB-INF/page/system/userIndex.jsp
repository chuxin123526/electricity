   ...
   function deleteAll(){
     ...
     if(!flag){
     	...
     	if(!confirmflag){
     		...
     		document.Form2.action = "userAction_delete.action";
...
<HTML>
	...
	<body >
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/system/userAction_query.action" method="post" style="margin:0px;"> 
			<table cellspacing="1" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
				...
				<tr>
					...
					姓名：</td>
					<td class="ta_01" >
						<input type="text" name="user.name" size="21" value="" id="userName"/>
					</td>
					<td class="ta_01" align="center" bgcolor="#f5fafe" height="22">
					所属区域：</td>
					<td class="ta_01" >
					<s:select list="areaList" listKey="id"  listValue="name" name="areaId" headerKey="" headerValue="请选择" cssStyle="width:155px">
				...
				<tr>
					...
					<td class="ta_01" colspan="3">
						<input type="text" name="onDutyBegin" id="onDutyDateBegin" maxlength="50" size="20" onclick="WdatePicker()"/>
						~
						<input type="text" name="onDutyEnd" id="onDutyDateEnd" maxlength="50" size="20" onclick="WdatePicker()"/>
					</td>
				</tr>
		...
		<form id="Form2" name="Form2" action="${pageContext.request.contextPath }/system/userAction_query.action" method="post">
		<table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
			<TBODY>
				<TR height=10><td></td></TR>			
				<tr>
					...
					<td class="ta_01" align="right">
						...
						<input style="font-size:12px; color:black; height=20;width=80" id="BT_Add" type="button" value="添加用户" name="BT_Add" 
						 onclick="openWindow('userAction_add.action','900','700')">&nbsp;&nbsp;
								...
								<s:iterator value="userList">
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										<td style="HEIGHT:22px" align="center" width="5%">
											<input type="checkbox" name="userIDS" id="userID" value="${id}">
										</td>
										...
										<td align="center" style="HEIGHT: 22px" align="center" width="10%">																	
										   <a href="#" onclick="openWindow('userAction_edit.action?user.id=${id}','900','700');">
